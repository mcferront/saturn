...
/*
 * Fix applied EAH - SoE DTS 10/July/96
 *
 * This software when compiled with
 *
 * 		cygnus-2.6-95q1-SOA-950317
 *
 * generates a link error, ie. an undefined reference to __main
 *
...
/*
 * If you are using a run address other than the
 * default 6010000H, then read the notes relating to the
 * '1st Read Address' section in the file sys_id.src.
 */
