...
#else
#define REG_DXR   ((volatile Uint32 *)0x06060000)  /* 読み込みアドレス              */
#define REG_DXW   ((volatile Uint32 *)0x06060004)  /* 書き出しアドレス              */
#define REG_DXC   ((volatile Uint32 *)0x06060008)  /* 転送バイト数　　　            */
#define REG_DXAD  ((volatile Uint32 *)0x0606000C)  /* 加算値レジスタ　　            */
#define REG_DXEN  ((volatile Uint32 *)0x06060010)  /* DMA許可レジスタ 　            */
#define REG_DXMD  ((volatile Uint32 *)0x06060014)  /* DMAﾓｰﾄﾞ、ｱﾄﾞﾚｽ更新、起動要因　*/
#endif /* _DEB */
/******** チャネルオフセット *************************************************/
...
/******** 共通 ***************************************************************/
#ifndef _DEB
#define REG_DSTP    ((Uint32 *)0x25fe0060)  /* DMA強制停止レジスタ         　*/
#else
