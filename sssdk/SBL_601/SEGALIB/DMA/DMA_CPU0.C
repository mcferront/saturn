 ...
 *
 *  MOD HISTORY:
 *      '95-11/14 DRDCR0/DRCR1のDREQ指定禁止への対応 
 *
 *-----------------------------------------------------------------------------
 */
...
/**** DMAレジスタアドレス ****************************************************/
/******** チャネル0 **********************************************************/
#define REG_SAR     ((volatile Uint32 *)0xffffff80)  /* ソースアドレスレジスタ        */
#define REG_DAR     ((volatile Uint32 *)0xffffff84)  /* ディスティネーションアドレス- */
                                            /* レジスタ                      */
#define REG_TCR     ((volatile Uint32 *)0xffffff88)  /* トランスファカウントレジスタ  */
#define REG_CHCR    ((volatile Uint32 *)0xffffff8C)  /* チャネルコントロールレジスタ  */
#define REG_DRCR    ((volatile Uint8  *)0xfffffe71)  /* DMA要求／応答選択制御レジスタ */
/******** チャネルオフセット *************************************************/
 ...
 *
 * CAVEATS:
 *      prm->drcrに設定可能なのはDMA_CPU_RXIとDMA_CPU_TXIのみ。
 *
 ******************************************************************************
 */
...
/*
 *  DRDCR0/DRCR1のDREQ指定禁止への対応 '95-11/14 H.O
 */
#if 0	/*Old Code*/
