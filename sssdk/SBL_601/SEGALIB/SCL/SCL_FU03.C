...
#if	0
/*
**	1995.09.29 c.yoshida
**	パラメータＡとパラメータＢでアドレスを変えられないから
*/
		...
		temp = (0x003f & ((scfg->plate_addr[i * 2 + 1] - SCL_VDP2_VRAM)
			...
			map2[i] = (0x003f & ((scfg->plate_addr[16+(i*2)] - SCL_VDP2_VRAM)/ boundary));
			temp = (0x003f & ((scfg->plate_addr[16+(i*2+1)] - SCL_VDP2_VRAM)/ boundary)) << 8;
#endif
		map2[i] |= (temp & 0x3f00);
	    }
	}
