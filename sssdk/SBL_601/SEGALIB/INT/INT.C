...
*			declare functions			*
****************************************/
void	__interrupt_handler0( void );
void	__interrupt_handler1( void );
void	__interrupt_handler2( void );
void	__interrupt_handler3( void );
void	__interrupt_handler4( void );
void	__interrupt_handler5( void );
void	__interrupt_handler6( void );
void	__interrupt_handler7( void );
void	__interrupt_handler8( void );
void	__interrupt_handler9( void );
void	__interrupt_handler10( void );
void	__interrupt_handler11( void );
void	__interrupt_handler12( void );
void	__interrupt_handler13( void );
void	__interrupt_handler14( void );
void	__interrupt_handler15( void );
void	__interrupt_handler16( void );
void	__interrupt_handler17( void );
void	__interrupt_handler18( void );
void	__interrupt_handler19( void );
void	__interrupt_handler20( void );
void	__interrupt_handler21( void );
void	__interrupt_handler22( void );
void	__interrupt_handler23( void );
void	__interrupt_handler24( void );
void	__interrupt_handler25( void );
void	__interrupt_handler26( void );
void	__interrupt_handler27( void );
void	__interrupt_handler28( void );
void	__interrupt_handler29( void );
void	__interrupt_handler30( void );
void	__interrupt_handler31( void );
...
****************************************/
static interrupt_t	__interrupt_handler[256] = {
...
void	INT_SetScuFunc( int	n, interrupt_t	handler ){
	...
	_INT_SetScuFunc( n, __interrupt_handler[n] );
}
