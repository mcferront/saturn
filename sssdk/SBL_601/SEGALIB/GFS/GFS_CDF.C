...
void GFCF_SetSct(GfsFlow *flow, Sint32 sct)
{
    ...
    GFS_FLW_SCTCNT(flow) = MIN(nsct, sct);
}
...
Sint32 GFCF_GetStat(Sint32 *fad, Sint32 *hirq)
{
    ...
    } else if (gfcd_fatal_err == GFCD_ERR_OPEN) {
        return GFS_STAT_OPEN;
    } else if (gfcd_fatal_err == GFCD_ERR_NODISC) {
