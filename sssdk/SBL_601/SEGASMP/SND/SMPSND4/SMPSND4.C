...
static Uint16 * volatile l_move_pcm_adr;        /* PCM転送アドレス           */
...
void main(void)
{
	...
	*/
    ...
    move_pcm_adr   = (Uint16 *)0x06020000;   /* 右チャネル転送元              */
    l_move_pcm_adr = (Uint16 *)0x06055000;   /* 左チャネル転送元              */
#if	0
	/*
	...
	*/
    ...
    INT_SetScuFunc(INT_SCU_SND, PcmIntr);          /* 割り込み処理登録     */
    INT_ChgMsk(INT_MSK_SND,INT_MSK_NULL);       /* サウンド割り込み許可      */
    
	/*
	** 1995-11-07 K.Kawai
	** for sddrvs ver 2.00
	*/
    SND_INI_PRG_ADR(snd_init) = (Uint16 *)0x6090000;
    SND_INI_PRG_SZ(snd_init) = (Uint16 )0x6390;
    SND_INI_ARA_ADR(snd_init) = (Uint16 *)0x608c000;
