...
/*    WordCopyforVRAM((void *)char_ram, grandu_char, sizeof(grandu_char));	*/
    WordCopyforVRAM((void *)char_ram,(void *)grandu_char, sizeof(grandu_char));
...
*/
	MapCopyforVRAM((void *)char_ram             ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+16*4)      ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+32*4)      ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+48*4)      ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+4096)      ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+4096+16*4) ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+4096+32*4) ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+4096+48*4) ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+8192)      ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+8192+16*4) ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+8192+32*4) ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+8192+48*4) ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+12288)     ,(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+12288+16*4),(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+12288+32*4),(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+12288+48*4),(void *) &grandu_map[i*16],Offset,16*2);
							/* henko 95.7.11 Chikohiro Yoshida */
	char_ram += 64*4;
    }

    /* Set Color Data into Color RAM */
/*    WordCopyforVRAM((void *)col_ram, grandu_col,sizeof(grandu_col));	*/
    WordCopyforVRAM((void *)col_ram,(void *)grandu_col,sizeof(grandu_col));
									/* henko 95.7.11 Chikahiro Yoshida	*/
}
...
/*    WordCopyforVRAM((void *)char_ram, skyu_char, sizeof(skyu_char));	*/
    WordCopyforVRAM((void *)char_ram,(void *)skyu_char, sizeof(skyu_char));
								/* henko 95.7.11 Chikahiro Yoshida */
...
*/
	MapCopyforVRAM((void *)char_ram       ,(void *)&skyu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+16*4),(void *)&skyu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+32*4),(void *)&skyu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+48*4),(void *)&skyu_map[i*16],Offset,16*2);
										/* henko 95.7.11 Chikahiro Yoshida */
	char_ram += 64*4;
    }
...
/*    WordCopyforVRAM((void *)col_ram, skyu_col,sizeof(skyu_col));	*/
    WordCopyforVRAM((void *)col_ram,(void *)skyu_col,sizeof(skyu_col));
								/* henko 95.7.11 Chikahiro Yoshida */
